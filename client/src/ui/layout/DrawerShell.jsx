...
export function AccountPanel({ onLogout }) {
  return (
...
export function AccountIdentity({ badge, caption, name }) {
  return (
...
function DrawerSidebar({ account, brand, navAriaLabel, navGroups, onClose }) {
  return (
    <aside className="flex min-h-full w-72 flex-col bg-base-100 text-base-content lg:border-r lg:border-base-300">
      <div className="relative flex min-h-20 items-center justify-center border-b border-base-300 px-3">
...
function DrawerShell({ account, accountIdentity, brand, children, drawerId = 'app-drawer', navAriaLabel = 'App pages', navGroups, title }) {
